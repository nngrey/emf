...
def seed_framework
  ...
  indicator = PerformanceIndicator.create(description: 'Number of filters installed')
  eval_question = framework.evaluative_questions.create(category: 'effectiveness', description: 'To what degree were water filters installed', performance_indicators: [indicator])
